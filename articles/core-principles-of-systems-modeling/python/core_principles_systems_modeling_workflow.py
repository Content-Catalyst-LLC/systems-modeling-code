...
4. Capacity-limited nonlinear growth
5. Threshold-sensitive correction
6. Scenario comparison
7. Sensitivity analysis
8. Validation against synthetic target ranges
...
def main() -> None:
    ...
    write_csv(TABLES / "python_core_principles_inventory.csv", read_csv(DATA / "core_principles_inventory.csv"))
    write_csv(TABLES / "python_core_principles_timeseries.csv", rows)
    write_csv(TABLES / "python_core_principles_summary.csv", summary_rows)
    write_csv(TABLES / "python_core_principles_sensitivity.csv", sensitivity_rows)
    write_csv(TABLES / "python_core_principles_validation.csv", validation_rows)
