...
Metrics simulate(const Parameters& p) {
    ...
    stock.reserve(200);
    stock.push_back(15.0);

    double min_stock = 15.0;
    double max_stock = 15.0;
    int time_to_peak = 0;
...
int main() {
    std::mt19937 rng(70606);
    std::uniform_real_distribution<double> growth_rate(0.060, 0.130);
    std::uniform_real_distribution<double> balancing_strength(0.020, 0.090);
    std::uniform_real_distribution<double> target(45.0, 70.0);
    std::uniform_int_distribution<int> delay(2, 14);
    std::uniform_real_distribution<double> capacity(65.0, 110.0);
    std::uniform_real_distribution<double> threshold(65.0, 95.0);
    std::uniform_real_distribution<double> threshold_correction(0.020, 0.105);
