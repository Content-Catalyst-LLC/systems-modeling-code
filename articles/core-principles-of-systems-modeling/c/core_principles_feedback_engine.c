...
int main(void) {
    ...
    const double balancing_strength = 0.050;
    const double target = 55.0;
    const int delay = 6;
    const double capacity = 90.0;
    ...
    printf("time,stock,delayed_stock,reinforcing_inflow,balancing_outflow,threshold_penalty,shock,next_stock\n");
