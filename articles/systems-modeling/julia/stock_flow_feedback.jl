# Systems Modeling in Julia
# Compact stock-and-flow feedback simulation.
# Educational example only.

function simulate_interacting_stocks(steps)
    stock_a = zeros(steps)
    stock_b = zeros(steps)
...
stock_a, stock_b = simulate_interacting_stocks(140)

println("Final stock A: ", stock_a[end])
println("Final stock B: ", stock_b[end])
