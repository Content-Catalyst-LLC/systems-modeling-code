...
int main(void) {
    ...
    printf("scenario,final_adoption_share,final_adopter_count,maximum_adoption_gap,time_to_25_percent,time_to_50_percent,peak_growth\n");

    for (int i = 0; i < 7; ++i) {
        printf("%s,%.6f,%d,%.6f,%d,%d,%.6f\n",
               summaries[i].scenario,
               summaries[i].final_adoption_share,
               summaries[i].final_adopter_count,
               summaries[i].maximum_adoption_gap,
               summaries[i].time_to_25_percent,
               summaries[i].time_to_50_percent,
               summaries[i].peak_growth);
    }
